...
try {
    $pdo->exec("INSERT INTO items (id,content_id,title,item_source,release_date) VALUES (102,'fixture002','検証用の別作品','fanza_product',CURDATE())");
    ...
    $desc = pcf_meta_description('短い説明','テスト作品','item.php','PinkClub FANZA');
