...
<section class="admin-card admin-card--form">
  ...
  <form method="post">
    ...
    <label>本文<textarea name="body" rows="12" required><?= e($values['body']) ?></textarea></label>
    <label>SEOタイトル<input name="seo_title" value="<?= e($values['seo_title']) ?>"></label>
    <label>SEO説明<textarea name="seo_description" rows="3"><?= e($values['seo_description']) ?></textarea></label>
