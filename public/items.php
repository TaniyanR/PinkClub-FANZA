...
<h2>商品一覧</h2><table><tr><th>画像</th><th>タイトル</th><th>発売日</th><th>価格</th></tr><?php foreach($rows as $r):?><tr><td><?php if($r['image_small']):?><img class="thumb" src="<?=e($r['image_small'])?>"><?php else:?>-<?php endif;?></td><td><a href="<?=e(public_url('item.php?id='.(int)$r['id']))?>"><?=e($r['title'])?></a></td><td><?=e($r['release_date']??'')?></td><td><?=e($r['price_min_text']??'')?></td></tr><?php endforeach;?></table>
