...
try {
    $stmt = db()->prepare('SELECT * FROM items' . $sourceWhereSql . ' ORDER BY id DESC LIMIT :l OFFSET :o');
...
<?php if ($rows !== []): ?>
  <section class="rail-section">
    <div class="rail-row--items-grid" style="display:grid; grid-template-columns:repeat(4,minmax(0,1fr)); gap:16px; overflow:visible; padding-bottom:0;">
