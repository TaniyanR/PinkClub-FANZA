      ...
      <table style="width:100%; border-collapse:collapse; table-layout:fixed;">
        ...
        <tbody>
          <?php foreach ($accessRankingRows as $index => $rankingRow): ?>
            <tr>
              <td style="padding:8px; border-bottom:1px solid #eee; text-align:center; background:#0b5ed7; color:#fff;"><?= e((string)($index + 1)) ?></td>
              <td style="padding:8px; border-bottom:1px solid #eee; text-align:center; background:#0b5ed7; color:#fff;"><?= e((string)($rankingRow['title'] ?? '')) ?></td>
              <td style="padding:8px; border-bottom:1px solid #eee; text-align:center; background:#0b5ed7; color:#fff;"><?= e((string)((int)($rankingRow['access_count'] ?? 0))) ?></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
