...
echo '<!doctype html><html lang="ja"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>商品一覧表示確認</title></head><body><main style="padding:40px;font-family:sans-serif;"><h1>商品一覧表示確認</h1><p>このURLは public/items.php を実行しています。商品カード表示は切り分けのため一時停止中です。</p></main></body></html>';
exit;
...
<?php else: ?>
  <?php pcf_render_empty('商品一覧の表示箇所を確認するため、商品カード表示を一時的に削除しています。'); ?>
<?php endif; ?>
