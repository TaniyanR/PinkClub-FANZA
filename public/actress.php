...
<section class="pcf-profile pcf-profile--plain pcf-actress-profile" style="display:grid;grid-template-columns:minmax(220px,320px) 1fr;column-gap:20px;row-gap:0;align-items:start;">
  <h1 class="pcf-hero__title pcf-actress-profile__title" style="grid-column:2;margin:0 0 16px;padding:0 0 6px 8px;border-left:8px solid #002bff;border-bottom:2px solid #002bff;"><?= e($actressDisplayName) ?></h1>
  <img class="pcf-actress-profile__image" src="<?= e($profileImage) ?>" alt="<?= e($actressDisplayName) ?>" style="grid-column:1;grid-row:1 / span 2;width:100%;max-width:320px;aspect-ratio:1/1;object-fit:cover;border-radius:6px;">
...
<?php if ($list !== []): ?>
  <section class="pcf-related-grid pcf-actress-related-grid">
