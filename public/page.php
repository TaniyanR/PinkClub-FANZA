...
if ($slug === 'about' || $slug === 'privacy-policy') {
    ...
    $pageBodyHtml = str_replace(
        ['「お問い合わせ」', '【お問い合わせ】にて', '__PCF_PRIVACY_POLICY_LINK__ページ', '__PCF_PRIVACY_POLICY_LINK__', $privacyLink . 'ページ', '__PCF_ACCESS_RANKING__'],
        ['「' . $contactLink . '」', '【' . $contactLink . '】にて', $privacyLink, $privacyLink, $privacyLink, $rankingHtml],
        $pageBodyHtml
    );
}
if ($slug === 'about') {
