...
<?php else: ?>
  <section class="rail-section">
    ...
    <div class="rail-row rail-row--220 rail-row--wide-thumb rail-row--bottom-scroll rail-row--bottom-horizontal"><?php foreach ($latestBottom as $item) { render_item_card($item, 220, null, true); } ?></div>
  </section>
  ...
  <section class="rail-section">
    ...
    <div class="rail-row rail-row--220 rail-row--wide-thumb rail-row--bottom-scroll rail-row--bottom-horizontal"><?php foreach ($pickupBottom as $item) { render_item_card($item, 220, null, true); } ?></div>
  </section>
