...
<?php else: ?>
  <section class="rail-section">
    <h2>新着作品</h2>
    <div class="rail-row rail-row--220 rail-row--no-scroll rail-row--top-shift rail-row--tall-cards"><?php foreach ($latestTop as $item) { render_item_card($item, 220); } ?></div>
    <div class="rail-row rail-row--220 rail-row--wide-thumb rail-row--bottom-scroll rail-row--bottom-horizontal rail-row--tall-cards"><?php foreach ($latestBottom as $item) { render_item_card($item, 220, null, true); } ?></div>
  </section>

  <section class="rail-section">
    <h2>ピックアップ（人気順）</h2>
    <div class="rail-row rail-row--220 rail-row--no-scroll rail-row--top-shift rail-row--tall-cards"><?php foreach ($pickupTop as $item) { render_item_card($item, 220); } ?></div>
    <div class="rail-row rail-row--220 rail-row--wide-thumb rail-row--bottom-scroll rail-row--bottom-horizontal rail-row--tall-cards"><?php foreach ($pickupBottom as $item) { render_item_card($item, 220, null, true); } ?></div>
  </section>
