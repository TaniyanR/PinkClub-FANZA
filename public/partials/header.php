...
if ($faviconPath !== '') {
    ...
    $faviconUrl = str_starts_with($faviconNormalizedPath, 'uploads/site_settings/') ? public_url('site_asset.php?type=favicon&file=' . rawurlencode(basename($faviconNormalizedPath))) : asset_url($faviconNormalizedPath);
}
