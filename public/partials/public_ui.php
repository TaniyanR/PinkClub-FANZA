...
if (!function_exists('pcf_render_item_card')) {
    function pcf_render_item_card(array $item): void
    {
        ...
        echo '<article class="pcf-item-card" style="background:#fff;border:1px solid #d7dce5;border-radius:4px;padding:6px 6px 10px;width:392px;max-width:392px;box-sizing:border-box;">';
        ...
        if ($sampleMovieUrl !== '') {
            echo '<a class="sample-button sample-button--enabled" href="' . e($sampleMovieUrl) . '" target="_blank" rel="noopener noreferrer" style="display:block;background:#2b52d1;color:#fff;text-align:center;padding:8px 12px;border-radius:5px;text-decoration:none;font-weight:700;">サンプル動画</a>';
        } else {
            echo '<span class="sample-button sample-button--disabled" style="display:block;background:#9aa3b2;color:#fff;text-align:center;padding:8px 12px;border-radius:5px;font-weight:700;">サンプル動画</span>';
        }
        if ($sampleImageUrl !== '') {
            echo '<a class="sample-button sample-button--enabled" href="' . e($sampleImageUrl) . '" style="display:block;background:#2b52d1;color:#fff;text-align:center;padding:8px 12px;border-radius:5px;text-decoration:none;font-weight:700;">サンプル画像</a>';
        } else {
            echo '<span class="sample-button sample-button--disabled" style="display:block;background:#9aa3b2;color:#fff;text-align:center;padding:8px 12px;border-radius:5px;font-weight:700;">サンプル画像</span>';
        }
        echo '<a class="sample-button sample-button--enabled" href="' . e($itemUrl) . '" style="display:block;background:#2b52d1;color:#fff;text-align:center;padding:8px 12px;border-radius:5px;text-decoration:none;font-weight:700;">詳細ページ</a>';
        echo '</div>';
