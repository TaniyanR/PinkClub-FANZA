    ...
    function pcf_render_item_card(array $item): void
    {
        ...
        if ($cardImages !== []) {
            foreach ($cardImages as $imageUrl) {
                echo '<img class="thumb pcf-item-card__thumb" src="' . e($imageUrl) . '" alt="' . e($title) . '" loading="lazy" style="width:calc(50% - 2px);">';
            }
            if (count($cardImages) === 1) {
                echo '<img class="thumb pcf-item-card__thumb" src="' . e($cardImages[0]) . '" alt="' . e($title) . '" loading="lazy" style="width:calc(50% - 2px);">';
            }
        } else {
            echo '<img class="thumb pcf-item-card__thumb" src="' . e(pcf_placeholder_data_uri('No Image')) . '" alt="' . e($title) . '" loading="lazy" style="width:calc(50% - 2px);">';
            echo '<img class="thumb pcf-item-card__thumb" src="' . e(pcf_placeholder_data_uri('No Image')) . '" alt="' . e($title) . '" loading="lazy" style="width:calc(50% - 2px);">';
        }
        echo '</a>';
