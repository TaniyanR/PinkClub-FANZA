...
if (!function_exists('pcf_render_item_card')) {
    function pcf_render_item_card(array $item, int $width = 180, bool $preferFullPackageImage = false): void
    {
        ...
        if ($affiliateUrl !== '') {
            echo '<a class="pcf-dm-card__button" href="' . e($affiliateUrl) . '" target="_blank" rel="noopener noreferrer">FANZAで見る</a>';
        } else {
            echo '<span class="pcf-dm-card__button is-disabled">FANZAで見る</span>';
        }
