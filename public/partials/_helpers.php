...
if (!function_exists('render_shared_content_ad_row')) {
    function render_shared_content_ad_row(string $position_key, string $page_type): void
    {
        ...
        echo '<div class="content-ad-row__rss"><h2 class="content-ad-row__rss-title">テキストRSS</h2>' . $rssHtmlLeft . '</div>';
        echo '<div class="content-ad-row__rss"><h2 class="content-ad-row__rss-title">テキストRSS</h2>' . $rssHtmlRight . '</div>';
        echo '</div>';
    }
}
