    ...
    <section class="sidebar-block">
        ...
        <?php else: ?>
            <ul class="sidebar-links sidebar-links--pages">
                <?php if ($sitePostCount !== null): ?><li><a href="<?= e(public_url('items.php')) ?>">投稿数：<?= e(number_format($sitePostCount)) ?></a></li><?php endif; ?>
                <?php if ($siteActressCount !== null): ?><li><a href="<?= e(public_url('actresses.php')) ?>">女優数：<?= e(number_format($siteActressCount)) ?></a></li><?php endif; ?>
