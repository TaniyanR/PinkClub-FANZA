    ...
    <section class="sidebar-block">
        ...
        <?php else: ?>
            <ul class="sidebar-links sidebar-links--pages">
                <?php if ($sitePostCount !== null): ?><li><a>投稿数：<?= e(number_format($sitePostCount)) ?></a></li><?php endif; ?>
                <?php if ($siteActressCount !== null): ?><li><a>女優数：<?= e(number_format($siteActressCount)) ?></a></li><?php endif; ?>
