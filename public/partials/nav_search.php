...
<details class="site-mobile-menu only-sp">
    ...
    <div class="site-mobile-menu__body">
        ...
        <div class="site-mobile-menu__group">
            <?php if ($sitePostCount !== null): ?><a href="<?= e(public_url('items.php')) ?>">投稿数：<?= e(number_format($sitePostCount)) ?></a><?php endif; ?>
            <?php if ($siteActressCount !== null): ?><a href="<?= e(public_url('actresses.php')) ?>">女優数：<?= e(number_format($siteActressCount)) ?></a><?php endif; ?>
