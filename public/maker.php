...
?>
        <section class="block">
            <h1 class="section-title"><?php echo e((string)$maker['name']); ?></h1>
            <?php if (!empty($maker['ruby'])): ?><p><?php echo e((string)$maker['ruby']); ?></p><?php endif; ?>
        </section>
        <section class="block">
        ...
        <nav class="pagination">
            <?php if ($page > 1): ?><a class="page-btn" href="<?php echo e(build_url('/maker.php', ['id' => (string)$maker['id'], 'page' => (string)($page - 1)])); ?>">前へ</a><?php else: ?><span class="page-btn">前へ</span><?php endif; ?>
            <span class="page-btn is-current"><?php echo e((string)$page); ?></span>
            <?php if ($hasNext): ?><a class="page-btn" href="<?php echo e(build_url('/maker.php', ['id' => (string)$maker['id'], 'page' => (string)($page + 1)])); ?>">次へ</a><?php else: ?><span class="page-btn">次へ</span><?php endif; ?>
        </nav>
