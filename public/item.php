...
<article>
  ...
  <section class="pcf-detail">
    ...
    <div>
      ...
      <?php if ($seriesList !== []): ?><h3>シリーズ</h3><div class="pcf-tag-list"><?php foreach ($seriesList as $v): ?><a class="pcf-tag" href="<?= e(public_url('series_one.php?id=' . (int)($v['id'] ?? 0))) ?>"><?= e((string)($v['name'] ?? '')) ?></a><?php endforeach; ?></div><?php endif; ?>
