...
<div style="margin: 16px 0; display: flex; gap: 8px; flex-wrap: wrap;">
  ...
  <?php endif; ?>
  <?php if ($sampleImages !== []): ?>
    <button type="button" onclick="window.open('<?= e(public_url('sample_images.php?content_id=' . rawurlencode((string)$item['content_id']))) ?>', '_blank', 'noopener,noreferrer,width=860,height=620')">サンプル画像</button>
  <?php endif; ?>
</div>
