...
<article>
  ...
  <section class="pcf-detail pcf-item-main">
    ...
    <div class="pcf-item-main__info">
      <table style="width:100%; border-collapse:collapse; color:#000 !important; font-size:14px;">
        <tbody>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">対応デバイス</th><td style="padding:4px 0;"><?= e($deviceText !== '' ? $deviceText : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">配信開始日</th><td style="padding:4px 0;"><?= e($deliveryStartDisplay !== '' ? $deliveryStartDisplay : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">商品発売日</th><td style="padding:4px 0;"><?= e($releaseDateDisplay !== '' ? $releaseDateDisplay : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">収録時間</th><td style="padding:4px 0;"><?= e($volumeDisplay !== '' ? $volumeDisplay : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">出演者</th><td style="padding:4px 0;"><?= e($performerText !== '' ? $performerText : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">監督</th><td style="padding:4px 0;"><?= e($rawDirectorName !== '' ? $rawDirectorName : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">シリーズ</th><td style="padding:4px 0;"><?= e($rawSeriesName !== '' ? $rawSeriesName : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">メーカー</th><td style="padding:4px 0;"><?= e($rawMakerName !== '' ? $rawMakerName : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">レーベル</th><td style="padding:4px 0;"><?= e($labelName !== '' ? $labelName : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">ジャンル</th><td style="padding:4px 0;"><?= e($genreText !== '' ? $genreText : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">関連タグ</th><td style="padding:4px 0;"><?= e($tagText !== '' ? $tagText : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">配信品番</th><td style="padding:4px 0;"><?= e($contentIdDisplay !== '' ? $contentIdDisplay : '―') ?></td></tr>
          <tr><th style="text-align:left; font-weight:700; padding:4px 8px 4px 0; white-space:nowrap;">メーカー品番</th><td style="padding:4px 0;"><?= e($productIdDisplay !== '' ? $productIdDisplay : '―') ?></td></tr>
        </tbody>
      </table>
    </div>
  </section>
